...
Juliette Regimbal est chercheuse à [Hitachi Énergie](https://hitachienergy.com/ca/fr) où elle travaille sur l'interaction humain-machine dans les systèmes électriques.
Récemment, elle a complété un doctorat en génie électrique au [Shared Reality Lab](https://srl.mcgill.ca) à l'Université McGill.
Les intérêts de recherche de Juliette incluent les interfaces audio et haptique, le soutien à la créativité, l'accessibilité, les méthodes de recherche qualitative, l'architecture logicielle et la technologie de la musique.
Hors de son travail, Juliette aime la cuisine, l'enseignement, la photographie, la radio logicielle, du bon café et *Star Trek*.

Ses projets incluent:
* [The Haptic Authoring Tool Box (HAT Box)](https://srl.mcgill.ca/hat-box) (aussi [sur GitHub](https://github.com/JRegimbal/hat-box), [CHI'26](https://doi.org/10.1145/3772318.3790575))
