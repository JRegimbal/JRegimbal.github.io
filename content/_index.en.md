...
Juliette Regimbal is a researcher at [Hitachi Energy](https://www.hitachienergy.com/) where she works on human-computer interaction in power systems.
Recently, they completed a PhD in electrical engineering at the [Shared Reality Lab](https://srl.mcgill.ca) at McGill University.
Juliette's research interests include audio and haptic interfaces, creativity support, accessibility, qualitative research methods, software architecture, and music technology.
Outside of work, Juliette enjoys cooking, teaching, photography, software-defined radio, good coffee, and *Star Trek*.

Her projects include:
* [The Haptic Authoring Tool Box (HAT Box)](https://srl.mcgill.ca/hat-box) (also [on GitHub](https://github.com/JRegimbal/hat-box), [CHI'26](https://doi.org/10.1145/3772318.3790575))
